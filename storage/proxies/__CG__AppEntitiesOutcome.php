 ...
 */
class Outcome extends \App\Entities\Outcome implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Outcome' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Outcome' . "\0" . 'value', '' . "\0" . 'App\\Entities\\Outcome' . "\0" . 'answer'];
        }
